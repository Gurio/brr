...
- **Hub: [environments](subject-envs.md)** — synthesis of the `EnvBackend`
...
- [Env protocol design](design-env-interface.md) — *accepted on
  2026-05-06*. Shipped protocol and per-env mechanics, plus the
  designed-but-pending `ssh` / `devcontainer` and plugin / script-env
  surfaces. Tactical companion to the env slice of the fleet deck.
